...
`
   <article class="detail">
      ...
      <p class="detail__rezume">
         Отправляйте резюме на
         <a class="modal__link blue-text" href="mailto:creativepeople@gmail.com">CreativePeople@gmail.com</a>
      </p>
   </article>
`;
...
const init = () => {
   ...
   const vacansiesFilter = document.querySelector('.vacancies__filter');

   vacansiesFilterBtn.addEventListener('click', () => {
      if (vacansiesFilterBtn.classList.contains('vacancies__filter-btn_active')) {
         closeFilter(
            vacansiesFilterBtn,
            vacansiesFilter,
   ...
   const cityChoices = new Choices(city_select, {
      itemSelectText: "",
   });
